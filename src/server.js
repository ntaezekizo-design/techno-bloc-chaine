...
// ─── Trust proxy (OBLIGATOIRE derrière Render / Nginx / Heroku) ──────────────
// Sans ça, cookie.secure ne fonctionne pas car Express voit HTTP interne
...
app.use(session({
  ...
  resave:            true,          // force save pour éviter la perte de session
  saveUninitialized: false,
  rolling:           true,          // renouvelle le cookie à chaque requête
  cookie: {
    // secure: true seulement si on est vraiment en HTTPS (détecté via trust proxy)
